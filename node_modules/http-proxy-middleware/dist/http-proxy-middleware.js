...
const configuration_1 = require("http-proxy-middleware/dist/configuration");
const get_plugins_1 = require("http-proxy-middleware/dist/get-plugins");
const path_filter_1 = require("http-proxy-middleware/dist/path-filter");
const PathRewriter = require("http-proxy-middleware/dist/path-rewriter");
const Router = require("http-proxy-middleware/dist/router");
const debug_1 = require("http-proxy-middleware/dist/debug");
const function_1 = require("http-proxy-middleware/dist/utils/function");
